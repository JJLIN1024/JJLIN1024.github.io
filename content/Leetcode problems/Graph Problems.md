...
draft: false
---
- [Algorithms for Competitive Programming - Graph](https://cp-algorithms.com/graph/breadth-first-search.html)
- [Connected Graph](https://web.ntnu.edu.tw/~algo/ConnectedGraph.html)
